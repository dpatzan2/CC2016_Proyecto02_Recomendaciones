    ...
    return (
        <div className="phase">
            <div className="text-center">
                ...
                <h1 className="text-center text-2xl mb-4 text-black">FASE 2 - Actores favoritos</h1>
            </div>
            <h2 className="text-center text-xl mb-4 text-black">Selecciona tus actores favoritos</h2>
            <hr />
            <br />
